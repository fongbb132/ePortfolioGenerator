    	...
    	$(data.pages).each(function(index,value){
    		...
    		if(page_pos == value.page_position){
    			...
    			$(value.component_array).each(function(index1, value1){
    				...
    				if(value1.component_type=="h"){
    					var $par = $('<h1>',{});
    					$par.text(value1.componet_content);
    					$(".page").append($par);
    				}
    			});
    		}
